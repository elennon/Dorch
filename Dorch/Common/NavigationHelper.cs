...
namespace Dorch.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        {         
            var d = this.Frame.CurrentSourcePageType;          
            if (this.Frame != null && d == typeof(ViewTeam))        // bypass the back stack and go straight back to teams screen
            {
                
                Frame.Navigate(typeof(MainPage));
            }
            else if (this.Frame != null && d == typeof(MainPage))
            {
                Application.Current.Exit();
            }
            else if (this.Frame != null && this.Frame.CanGoBack) this.Frame.GoBack();
        }
